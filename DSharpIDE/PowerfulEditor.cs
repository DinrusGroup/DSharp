...
namespace DSharpIDE
{
    public partial class PowerfulEditor : Form
    {
        ...
        CompilerGUI compilman;
       // FastColoredTextBox[]  openedtb;
        ...
        public static bool confOpened = false;
		 ...
		 /// <summary>
        /// Конструктор, который проверяет переменную DINRUS в среде,
		///прежде чем продолжает работу. Предполагается, что, если переменная
		///будет отсутствовать, то Динрус ещё не установлен, т.е. устанавливается.
		///Поэтому данная программа должна быть в корневой папке, а не в папке bin
        /// </summary>
        ...
        public PowerfulEditor()
        {
		 ...
		 /// <summary>
        /// Создаёт новую вкладку при нажатии элемента меню в тул-стрипе
        /// </summary>
		...
		/// <summary>
        /// Изменяет язык подсветки текста
        /// </summary>
        ...
        {
            changeLanguage(hLangTSCombo.Text);
            langChanged = true;
        }
