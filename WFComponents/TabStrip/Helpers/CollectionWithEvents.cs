...
{
    /// <summary>
    /// Представляет собой метод, который будет обрабатывать событие без данных.
    /// </summary>
    public delegate void CollectionClear();

    /// <summary>
    /// Представляет собой метод, который будет обрабатывать событие, у которого есть данные элемента.
    /// </summary>
